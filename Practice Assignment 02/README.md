...
A folder called “r_csv” with a R code for scraping the contact information in the SIM Home page [https://www.sim.edu.sg/] and saving the resulting output in the local folder (in CSV) <br>
